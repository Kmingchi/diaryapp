...
// 놀람 이모티콘
	...
	function addTodo() {
	    ...
	    // Create an img element for the todo.svg
	    const img = document.createElement('img');
	    img.src = '/image/icons/todo.svg';
	    img.alt = 'Todo Icon';
	...
	/* todolist diary btn */
	function goToDiary() {
	    window.location.href = 'diary';		// 다이어리 작성 페이지로 이동
	}
	...
	function todoAdd() {
	    ...
	    editImg.src = '/image/icons/edit.svg';
	    editImg.alt = '수정';
	    editImg.style.width = '20px';
	    editImg.style.height = '20px';
	
	    const deleteImg = document.createElement('img');
	    deleteImg.src = '/image/icons/delete.svg';
	    deleteImg.alt = '삭제';
	    ...
	    editButton.onclick = function() {
	        editTodoItem(li, editButton, deleteButton);
	    };
	...
	/* li 수정 */
	function editTodoItem(li, editButton, deleteButton) {
	    const currentText = li.childNodes[1].textContent;
	    ...
	    const seditImg = document.createElement('img');
	    seditImg.src = '/image/icons/save.svg';
	    seditImg.alt = '수정 완료';
	    seditImg.style.width = '20px';
	    seditImg.style.height = '20px';
	    
	    saveEditButton.appendChild(seditImg);
	    ...
	    saveEditButton.onclick = function() {
	        ...
	        li.appendChild(img);
	        li.appendChild(document.createTextNode(editInput.value));
	        li.appendChild(editButton);
	        li.appendChild(deleteButton);
	    };
	...
	// 디테일 모달에서 투두리스트 내용 추가 후 저장하는 완료 버튼
	function clearTodo() {
	    ...
	    const detailModal = document.getElementById('detailModalWrap');
	    detailModal.style.display = 'none'; // detailModalWrap 닫기
	
	    todoList.innerHTML = ''; // todo 리스트 초기화
	}
	
	// clearTodo 버튼에 clearTodo 함수 연결
